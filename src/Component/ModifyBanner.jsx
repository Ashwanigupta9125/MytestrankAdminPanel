...
export default function ModifyBanner() {
  ...
  const handleCheckBanner = async () => {
    ...
    try {
      const response = await axios.get(`https://www.srv620732.hstgr.cloud/banner/${bannerId}`)
  ...
  const handleUpdateBanner = async () => {
    ...
    try {
      const response = await axios.put(`https://www.srv620732.hstgr.cloud/banner/updatebanner/${bannerId}`, formData, {
